...
<?php
	...
	$query = mysqli_query($koneksi, "SELECT barang.*, kategori.kategori FROM barang JOIN kategori ON barang.kategori_id=kategori.kategori_id $where ORDER BY barang.barang_id DESC LIMIT $mulai_dari, 
	$data_per_halaman");
	...
	if(mysqli_num_rows($query) == 0){
		...
		$queryHitungBarang = "SELECT * FROM barang $where";
